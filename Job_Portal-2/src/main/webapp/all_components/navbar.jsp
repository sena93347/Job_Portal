	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<c:if test="${userobj.role eq 'admin' }">
				...
				<a href="logout.jsp" class="btn btn-light mr-1"><i
			...
			<c:if test="${userobj.role eq 'user' }">
				<a href="#" class="btn btn-light mr-1" data-toggle="modal"
					data-target="#exampleModal"><i class="fa-solid fa-user-large"></i>${userobj.userName }</a>

				<a href="logout.jsp" class="btn btn-light "><i
					class="fa-solid fa-right-to-bracket"></i>Logout </a>
			...
			<c:if test="${empty userobj }">
				...
				<a href="signup.jsp" class="btn btn-light"><i
					class="fa-solid fa-user-large"></i>SignUp </a>
			</c:if>
